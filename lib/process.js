(function() {
  var BufferedRequest, EventEmitter, LineBuffer, Process, Stream, client, debug, dirname, exec, exists, fs, isFunction, onceFileExists, packageBin, packageLib, pause, spawn, tmpFile, tryConnect, _ref, _ref2, _ref3;
    ...
    Process.prototype.request = function() {
      ...
      this.createConnection(__bind(function(err, connection) {
        ...
        if (err) {
          ...
          return req.assignSocket(clientRequest);
        }
      }, this));
      return req;
    };
