(function() {
  var EventEmitter, LineBuffer, Process, Stream, client, debug, exec, exists, fs, isFunction, onceFileExists, packageBin, packageLib, pause, spawn, tmpFile, tryConnect, _ref, _ref2;
