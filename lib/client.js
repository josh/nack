...
(function() {
  ...
  exports.ClientRequest = ClientRequest = (function(_super) {
    ...
    function ClientRequest() {
      return ClientRequest.__super__.constructor.apply(this, arguments);
    }

    ClientRequest.prototype._buildEnv = function() {
      var env, host, key, parts, pathname, query, value, _ref, _ref1, _ref2, _ref3, _ref4;
      env = {};
      ...
      if ((_ref1 = env['SERVER_NAME']) == null) {
        env['SERVER_NAME'] = "localhost";
      }
      if ((_ref2 = env['SERVER_PORT']) == null) {
        env['SERVER_PORT'] = "80";
      }
      _ref3 = this.headers;
      for (key in _ref3) {
