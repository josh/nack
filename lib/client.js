(function() {
  var Client, ClientRequest, ClientResponse, END_OF_FILE, Socket, Stream, assert, debug, fs, ns, url;
  ...
  exports.Client = Client = (function() {
    ...
    Client.prototype.proxy = function(serverRequest, serverResponse, next) {
      ...
      metaVariables = (_ref = serverRequest.proxyMetaVariables) != null ? _ref : {};
            if ((_ref2 = metaVariables['REMOTE_ADDR']) != null) {
        _ref2;
      } else {
        metaVariables['REMOTE_ADDR'] = "" + serverRequest.connection.remoteAddress;
      };
            if ((_ref3 = metaVariables['REMOTE_PORT']) != null) {
        _ref3;
      } else {
    ...
    ClientRequest.prototype._parseEnv = function(headers, metaVariables) {
      ...
      if (host = headers.host) {
        ...
        this.env['SERVER_PORT'] = parts[1];
            ...
            if ((_ref2 = (_base = this.env)['SERVER_NAME']) != null) {
        _ref2;
      } else {
        _base['SERVER_NAME'] = "localhost";
      };
            if ((_ref3 = (_base2 = this.env)['SERVER_PORT']) != null) {
        _ref3;
      } else {
        _base2['SERVER_PORT'] = "80";
      };
      for (key in headers) {
        value = headers[key];
