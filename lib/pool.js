...
(function() {
  var AggregateStream, EventEmitter, Pool, Stream, async, createProcess, isFunction, _ref,
  ...
  exports.Pool = Pool = (function(_super) {
    __extends(Pool, _super);

    function Pool(config, options) {
      var n, previousReadyWorkerCount, self, _i, _ref, _ref1;
      ...
      for (n = _i = 1, _ref1 = options.size; 1 <= _ref1 ? _i <= _ref1 : _i >= _ref1; n = 1 <= _ref1 ? ++_i : --_i) {
        this.increment();
      }
    }
  ...
  AggregateStream = (function(_super) {
    __extends(AggregateStream, _super);

    function AggregateStream() {
      _ref = AggregateStream.__super__.constructor.apply(this, arguments);
      return _ref;
    }
