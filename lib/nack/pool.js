(function() {
  var AggregateStream, BufferedReadStream, EventEmitter, Pool, _ref, createProcess, removeWorkerFromList;
  ...
  removeWorkerFromList = function(workers, workerToRemove) {
    var _i, _len, _ref2, index, worker;
    index = 0;
    _ref2 = workers;
  ...
  exports.Pool = (function() {
    ...
    Pool.prototype.increment = function() {
      ...
      process.on('busy', __bind(function() {
        removeWorkerFromList(this.readyWorkers, process);
        return this.emit('worker:busy', process);
      }, this));
      process.on('exit', __bind(function() {
        removeWorkerFromList(this.workers, process);
        removeWorkerFromList(this.readyWorkers, process);
    ...
    Pool.prototype.proxyRequest = function(req, res, callback) {
      ...
      this.onNext('worker:ready', function(worker) {
        return worker.proxyRequest(reqBuf, res, function() {
