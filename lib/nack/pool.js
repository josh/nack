(function() {
  ...
  exports.Pool = (function() {
    Pool = function(_arg, options) {
      ...
      readyWorkerCount = this.readyWorkers.length;
      this.on('worker:ready', __bind(function() {
        if (readyWorkerCount === 0 && this.readyWorkers.length > 0) {
          this.emit('ready');
        }
        return (readyWorkerCount = this.readyWorkers.length);
      }, this));
    ...
    Pool.prototype.proxyRequest = function(req, res, callback) {
      ...
      this.onNext('worker:ready', function(worker) {
        worker.proxyRequest(reqBuf, res, __bind(function(err) {
