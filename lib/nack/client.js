(function() {
  ...
  exports.Client = Client = (function() {
    ...
    Client.prototype._finishRequest = function() {
      var request, res;
      request = this._outgoing.shift();
      request.detachSocket(this);
      res = this._incoming;
      this._incoming = null;
  ...
  exports.ClientRequest = ClientRequest = (function() {
    ...
    ClientRequest.prototype.end = function(chunk, encoding) {
      ...
      flushed = this._writeQueue ? (this._writeQueue.push(END_OF_FILE), false) : this.connection ? this.connection.end(END_OF_FILE) : void 0;
