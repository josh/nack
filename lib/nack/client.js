(function() {
  var CRLF, Client, ClientRequest, ClientResponse, EventEmitter, Stream, StreamParser, WriteStream, _a, _b, _c, _d, sys, url;
  ...
  exports.ClientRequest = (function() {
    ClientRequest = function(_e, _f, _g, headers) {
      ...
      this.method = _f;
      this.socket = _e;
      this.bufferedSocket = new WriteStream(this.socket);
      this.writeable = true;
