(function() {
  var BufferedWriteStream, CRLF, Client, ClientRequest, ClientResponse, EventEmitter, Stream, StreamParser, _a, _b, _c, _d, sys, url;
  ...
  BufferedWriteStream = _c.BufferedWriteStream;
