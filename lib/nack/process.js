  ...
  exports.Process = Process = (function() {
    ...
    Process.prototype.spawn = function() {
      ...
      createPipeStream(this.pipePath, __bind(function(err, pipe) {
        var args, lastLine, stderrLines, stderrListener;
        if (err) {
        ...
        lastLine = null;
        stderrLines = new LineBuffer(this.stderr);
        stderrListener = function(line) {
          return lastLine = line;
        };
        stderrLines.on('data', stderrListener);
        this.onNext('ready', function() {
          return stderrLines.removeListener('data', stderrListener);
        });
        ...
        this.child.on('exit', __bind(function(code, signal) {
          ...
          if (code !== 0) {
            ...
            this.emit('error', exception || "unknown spawn error");
          }
