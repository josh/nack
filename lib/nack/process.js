(function() {
  var EventEmitter, Process, _ref, client, createPipeStream, exec, exists, fs, pause, spawn, tmpFile;
  ...
  exports.Process = (function() {
    ...
    Process.prototype.getNackWorkerPath = function(callback) {
      var _ref2;
      return (typeof (_ref2 = this.nackWorkerPath) !== "undefined" && _ref2 !== null) ? callback(null, this.nackWorkerPath) : exec('which nack_worker', __bind(function(error, stdout, stderr) {
        if (error) {
    ...
    Process.prototype.spawn = function() {
      ...
      this.getNackWorkerPath(__bind(function(err, nackWorker) {
        ...
        return createPipeStream(this.pipePath, __bind(function(err, stream) {
          var args, readyLineHandler;
          if (err) {
            return this.emit('error', err);
          }
          ...
          readyLineHandler = __bind(function(data) {
          ...
          this.child.on('exit', __bind(function(code, signal) {
            ...
            fs.unlink(this.pipePath, function() {});
